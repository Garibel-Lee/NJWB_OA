...
public class DeptDaoImpl implements DeptDao {
    ...
    public List<Dept> getDeptsPerPage(int currentPage, int size) throws SQLException {
        ...
        return JdbcTemplate.executeQuery(sql, new DeptMapper(), new Object[]{});
    }
    ...
    public int addDept(Dept dept) {
        ...
        Object[] objects = {dept.getDeptNo(),dept.getDeptName(),dept.getDeptLoc(),dept.getDeptManager(),dept.getDeptIntro()};
        try {
            count = JdbcTemplate.executeUpdate(sql, objects);
    ...
    public int updateDept(Dept dept) {
        ...
        Object[] objects = {dept.getDeptName(),dept.getDeptLoc(),dept.getDeptManager(),dept.getDeptNo()};
        try {
            count = JdbcTemplate.executeUpdate(sql, objects);
